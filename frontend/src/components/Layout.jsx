...
import {
  ...
  FileBarChart, ClipboardList, Wrench, PackageMinus,
} from 'lucide-react';
      ...
      <div className="sidebar-brand">
        <div className="flex items-center gap-3">
          <div className="sidebar-logo">
            <span className="font-display font-bold text-cro-teal-dark text-xs">CRO</span>
          </div>
          <div>
            <p className="font-semibold text-white text-sm leading-tight">Stock Patrimonial</p>
            <p className="text-white/40 text-[10px]">Conseil Regional Ouest</p>
          </div>
        </div>
      </div>
    ...
    <div className="page-bg flex min-h-screen">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="lg:hidden sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-cro-sand/80 px-4 h-14 flex items-center gap-3">
          ...
          <span className="font-semibold text-cro-ink text-sm">CRO Stock</span>
        </header>
