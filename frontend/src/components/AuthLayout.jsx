        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            <div className="sidebar-logo">
              <span className="font-display font-bold text-cro-teal-dark text-sm">CRO</span>
            </div>
            <div>
      ...
      <div className="auth-form-side">
        <div className="auth-form-box">
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            <div className="sidebar-logo"><span className="font-display font-bold text-cro-teal-dark text-sm">CRO</span></div>
            <span className="font-bold text-cro-ink">Gestion de Stock</span>
          </div>
